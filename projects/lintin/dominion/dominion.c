...
int adventurerCardEffect(int drawntreasure, struct gameState *state, int currentPlayer, int cardDrawn, int z) {
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return adventurerCardEffect(drawntreasure, state, currentPlayer, cardDrawn, z);
    case council_room:
          //+4 Cards
          for (i = 0; i < 4; i++)
      {
    ...
    case mine:
      return mineCardEffect(i, j, state, currentPlayer, choice1, choice2, handPos);
    case remodel:
      return remodelCardEffect(i, j, state, currentPlayer, choice1, choice2, handPos);
    case smithy:
